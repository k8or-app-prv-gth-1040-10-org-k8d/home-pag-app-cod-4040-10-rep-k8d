...
_ds.mK(a);return b}});var S3=function(a){return a.label?(0,_ds.Z)`<span class="devsite-mwc__label ${a.required?"devsite-mwc__label--required":""}">${a.label}</span>`:_ds.wH},T3=function(a){return a.icon?(0,_ds.Z)`<span class="devsite-mwc-text-field__icon">
      ...
      <select aria-labelledby="label"
              ...
              ?required="${a.required}"
              ?readonly="${a.readOnly}"
              name="${_ds.BR(""===a.name?void 0:a.name)}"
...
"devsite-mwc--no-label":!this.label,"devsite-mwc--outlined":this.outlined,"devsite-mwc--disabled":this.disabled,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--warning":this.warning,"devsite-mwc--floating":""!==this.value||this.focused}),b=S3(this),c=T3(this);var d=-1===this.minLength?void 0:this.minLength;const e=-1===this.maxLength?void 0:this.maxLength;d=(0,_ds.Z)`
      <input
          ...
          minlength="${null!=d?d:_ds.wH}"
          maxlength="${null!=e?e:_ds.wH}"
          name="${_ds.BR(""===this.name?void 0:this.name)}"
          @input="${this.j}"
          @blur="${this.o}"
          @focus="${this.ra}"
          @change="${this.g}">`;return(0,_ds.Z)`
    ...
    `;case "select":a:{for(a of this.options)if(a.value.trim()===this.value.trim()){a=a.text.trim();break a}a=""}return(0,_ds.Z)`
        <label class="devsite-mwc-select ${(0,_ds.ZK)({"devsite-mwc--disabled":this.disabled,"devsite-mwc--no-label":!this.label,"devsite-mwc--outlined":this.outlined,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--floating":""!==a||this.focused})}">
        ${S3(this)}
        ${T3(this)}
        ${U3(this)}
      </label>
    `;case "textarea":return a=(0,_ds.ZK)({"devsite-mwc--no-label":!this.label,"devsite-mwc--outlined":this.outlined,"devsite-mwc--disabled":this.disabled,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--floating":""!==this.value||this.focused}),b=S3(this),c=-1===this.minLength?void 0:this.minLength,d=-1===this.maxLength?void 0:this.maxLength,c=(0,_ds.Z)`<textarea
          aria-labelledby="label"
          ...
          cols="${this.cols}"
          name="${_ds.BR(""===this.name?void 0:this.name)}"
          minlength="${null!=c?c:_ds.wH}"
          maxlength="${null!=d?d:_ds.wH}"
          @input="${this.j}"
          @blur="${this.o}"
          @focus="${this.ra}"
          @change="${this.g}"></textarea>`,(0,_ds.Z)`
        <label class="devsite-mwc-text-area ${a}">
          ${b}
          ${c}
        </label>
        ${!this.charCounter&&this.maxLength?_ds.wH:(0,_ds.Z)`<span class="devsite-mwc-character-counter">${Math.min(this.value.length,this.maxLength)} / ${this.maxLength}</span>`}
    `;default:return(0,_ds.Z)`<span>Invalid element type</span>`}}};_ds.x([_ds.Oq("input"),_ds.y(HTMLInputElement)],V3.prototype,"inputElement",void 0);_ds.x([_ds.Oq("select"),_ds.y(HTMLSelectElement)],V3.prototype,"di",void 0);_ds.x([_ds.Oq("textarea"),_ds.y(HTMLTextAreaElement)],V3.prototype,"Rh",void 0);_ds.x([_ds.P({type:Boolean}),_ds.y(Object)],V3.prototype,"readOnly",void 0);_ds.x([_ds.P({type:String}),_ds.y(Object)],V3.prototype,"kind",void 0);
_ds.x([_ds.P({type:String}),_ds.y(String)],V3.prototype,"type",void 0);_ds.x([_ds.P({type:Boolean}),_ds.y(Object)],V3.prototype,"outlined",void 0);_ds.x([_ds.P({type:Boolean,Ya:!0}),_ds.y(Object)],V3.prototype,"required",void 0);_ds.x([_ds.P({type:Boolean,Ya:!0}),_ds.y(Object)],V3.prototype,"warning",void 0);_ds.x([_ds.P({type:Boolean,Ya:!0}),_ds.y(Object)],V3.prototype,"disabled",void 0);_ds.x([_ds.P({type:String}),_ds.y(Object)],V3.prototype,"label",void 0);
_ds.x([_ds.P({type:String}),_ds.y(Object)],V3.prototype,"icon",void 0);_ds.x([_ds.P({type:String}),_ds.y(Object)],V3.prototype,"placeholder",void 0);_ds.x([_ds.P({type:String}),_ds.y(Object)],V3.prototype,"value",void 0);_ds.x([_ds.P({type:String}),_ds.y(Object)],V3.prototype,"name",void 0);_ds.x([_ds.P({type:Boolean}),_ds.y(Object)],V3.prototype,"focused",void 0);_ds.x([_ds.P({type:Boolean,Ya:!0}),_ds.y(Object)],V3.prototype,"invalid",void 0);
_ds.x([_ds.P({type:Number}),_ds.y(Object)],V3.prototype,"rows",void 0);_ds.x([_ds.P({type:Number}),_ds.y(Object)],V3.prototype,"cols",void 0);_ds.x([_ds.P({type:Number}),_ds.y(Object)],V3.prototype,"minLength",void 0);_ds.x([_ds.P({type:Number}),_ds.y(Object)],V3.prototype,"maxLength",void 0);_ds.x([_ds.P({type:Boolean}),_ds.y(Object)],V3.prototype,"charCounter",void 0);_ds.x([_ds.P({type:String,Ya:!0}),_ds.y(Object)],V3.prototype,"staticPath",void 0);try{customElements.define("devsite-mwc",V3)}catch(a){console.warn("Unrecognized DevSite custom element - DevsiteMwc",a)};})(_ds_www);
